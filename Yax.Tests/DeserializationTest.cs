...
namespace Yax.Tests
{
    ...
    public class DeserializationTest
    {
        ...
        private void GetTheTwoStrings(object obj, out string originalString, out string gottonString, out int errorCounts)
        {
            ...
            var serializer = new YAXSerializer(obj.GetType(), ExceptionHandlingPolicies.DoNotThrow, YAXExceptionTypes.Warning, YAXSerializationOptions.SerializeNullObjects);
...
@"<MoreComplexBook2 Author_s_Name=""Tom Archer"">
  ...
  <Price>30.5</Price>
            ...
            YAXSerializer serializer = new YAXSerializer(typeof(MoreComplexBook2), ExceptionHandlingPolicies.DoNotThrow, YAXExceptionTypes.Warning, YAXSerializationOptions.SerializeNullObjects);
...
@"<SerializationOptionsSample>
  ...
  <ObjectWithoutOptionsSet>
    ...
    <StrNull />
            ...
            var serializer = new YAXSerializer(typeof(SerializationOptionsSample), ExceptionHandlingPolicies.DoNotThrow, YAXExceptionTypes.Warning, YAXSerializationOptions.DontSerializeNullObjects);

...
namespace Yax.Tests
{
    ...
    public class DeserializationTest
    {
        ...
        private void GetTheTwoStrings(object obj, out string originalString, out string gottonString, out int errorCounts)
        {
            ...
            var serializer = new Serializer(obj.GetType(), ExceptionHandlingPolicies.DoNotThrow, ExceptionTypes.Warning, SerializationOptions.SerializeNullObjects);
...
@"<MoreComplexBook2 Author_s_Name=""Tom Archer"">
  ...
  <Price>30.5</Price>
            ...
            Serializer serializer = new Serializer(typeof(MoreComplexBook2), ExceptionHandlingPolicies.DoNotThrow, ExceptionTypes.Warning, SerializationOptions.SerializeNullObjects);
...
@"<SerializationOptionsSample>
  ...
  <ObjectWithoutOptionsSet>
    ...
    <StrNull />
            ...
            var serializer = new Serializer(typeof(SerializationOptionsSample), ExceptionHandlingPolicies.DoNotThrow, ExceptionTypes.Warning, SerializationOptions.DontSerializeNullObjects);
